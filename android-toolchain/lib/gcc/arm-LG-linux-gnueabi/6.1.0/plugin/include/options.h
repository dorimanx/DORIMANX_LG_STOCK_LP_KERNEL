...
enum opt_code
{
  ...
  OPT_mabi_ = 1179,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1180,             /* -mabort-on-noreturn */
  OPT_mandroid = 1181,                       /* -mandroid */
  OPT_mapcs = 1182,                          /* -mapcs */
  OPT_mapcs_float = 1183,                    /* -mapcs-float */
  OPT_mapcs_frame = 1184,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1185,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1186,              /* -mapcs-stack-check */
  OPT_march_ = 1187,                         /* -march= */
  OPT_marm = 1188,                           /* -marm */
  OPT_masm_syntax_unified = 1189,            /* -masm-syntax-unified */
  OPT_mbig_endian = 1190,                    /* -mbig-endian */
  OPT_mbionic = 1191,                        /* -mbionic */
