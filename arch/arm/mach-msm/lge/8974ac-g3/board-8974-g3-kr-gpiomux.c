...
static struct msm_gpiomux_config bt_msm_blsp_configs[] __initdata = {
	{
		.gpio = 23, /* BLSP5 (BLSP 1 UART 4) TX */
		.settings = {
	...
	{
		.gpio = 24, /* BLSP5 (BLSP 1 UART 4) RX */
		.settings = {
	...
	{
		.gpio = 25, /* BLSP5 (BLSP 1 UART 4) CTS */
		.settings = {
	...
	{
		.gpio = 26, /* BLSP5 (BLSP 1 UART 4) RFR */
		.settings = {
...
/* LGE_CHANGE_S, [B2_Broadcast][hyun118.shin@lge.com], 2014-01-28, LGE_BROADCAST */
...
#endif /* LGE_BROADCAST */
/* LGE_CHANGE_S, [B2_Broadcast][hyun118.shin@lge.com], 2014-01-18, LGE_BROADCAST */
