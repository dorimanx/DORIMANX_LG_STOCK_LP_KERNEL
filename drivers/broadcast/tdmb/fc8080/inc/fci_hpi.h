...
extern fci_s32 fci_hpi_read(HANDLE handle, fci_u8 chip, fci_u8 addr, fci_u8 alen, fci_u8 *data,
				fci_u8 len);
extern fci_s32 fci_hpi_write(HANDLE handle, fci_u8 chip, fci_u8 addr, fci_u8 alen, fci_u8 *data,
				fci_u8 len);
