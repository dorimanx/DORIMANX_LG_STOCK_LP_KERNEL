...
#define SYNAPTICS_RMI4_DRIVER_PRODUCT (SYNAPTICS_RMI4_DS4 | SYNAPTICS_RMI4_DS5)
#define SYNAPTICS_RMI4_DRIVER_VERSION 0x1000
#define SYNAPTICS_DSX_DRIVER_VERSION "1.0.0"
