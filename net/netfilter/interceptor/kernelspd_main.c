...
static int debug_filter_string_set(const char *arg, struct kernel_param *kp)
{
...
module_param_call(debug_filter_string, debug_filter_string_set,
		  param_get_string, &kps, 0644);

MODULE_PARM_DESC(debug_filter_string,
